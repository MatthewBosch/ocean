...
# 接收 Alchemy RPC 账号
read -p "请输入 Alchemy RPC 账号（例如：3Gx2kLUZhTldBMVBgcl2Ow7o_cUhKaEz）: " rpc_account

# 验证输入的 RPC 账号格式
if [[ ! $rpc_account =~ ^[a-zA-Z0-9_-]{32}$ ]]; then
  echo "输入的 RPC 账号格式不正确，请确保是 32 位字符。"
  exit 1
fi
...
services:
  ocean-node:
    ...
    environment:
      ...
      RPCS: '{"1":{"rpc":"https://eth-mainnet.g.alchemy.com/v2/$rpc_account","fallbackRPCs":["https://rpc.ankr.com/eth","https://1rpc.io/eth","https://eth.api.onfinality.io/public"],"chainId":1,"network":"mainnet","chunkSize":100},"10":{"rpc":"https://opt-mainnet.g.alchemy.com/v2/$rpc_account","fallbackRPCs":["https://optimism-mainnet.public.blastapi.io","https://rpc.ankr.com/optimism","https://optimism-rpc.publicnode.com"],"chainId":10,"network":"optimism","chunkSize":100},"137":{"rpc":"https://polygon-mainnet.g.alchemy.com/v2/$rpc_account","fallbackRPCs":["https://polygon-mainnet.public.blastapi.io","https://1rpc.io/matic","https://rpc.ankr.com/polygon"],"chainId":137,"network":"polygon","chunkSize":100},"23294":{"rpc":"https://sapphire.oasis.io","fallbackRPCs":["https://1rpc.io/oasis/sapphire"],"chainId":23294,"network":"sapphire","chunkSize":100},"23295":{"rpc":"https://testnet.sapphire.oasis.io","chainId":23295,"network":"sapphire-testnet","chunkSize":100},"11155111":{"rpc":"https://eth-sepolia.g.alchemy.com/v2/$rpc_account","fallbackRPCs":["https://1rpc.io/sepolia","https://eth-sepolia.g.alchemy.com/v2/demo"],"chainId":11155111,"network":"sepolia","chunkSize":100},"11155420":{"rpc":"https://opt-sepolia.g.alchemy.com/v2/$rpc_account","fallbackRPCs":["https://endpoints.omniatech.io/v1/op/sepolia/public","https://optimism-sepolia.blockpi.network/v1/rpc/public"],"chainId":11155420,"network":"optimism-sepolia","chunkSize":100}}'
